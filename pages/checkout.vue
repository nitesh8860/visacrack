      ...
      <div class="md:flex gap-4 justify-between mx-auto w-full">
        ...
        <div class="md:w-[35%]">
          ...
          <div class="bg-white rounded-lg p-4 mt-4">
            <div class="text-lg font-semibold mb-2 mt-2">Visacrack</div>
            <p class="my-2">We keeps your information and payment safe</p>
          </div>
        </div>
      </div>
    </div>
...
const createOrder = async (stripeId) => {
  await useFetch("/api/prisma/create-order", {
    ...
    body: {
      ...
      contact: currentAddress.value.data.contact,
